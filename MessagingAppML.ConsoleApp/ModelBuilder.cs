...
namespace MessagingAppML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\vkolesnikova\OneDrive - Rightpoint\convertcsv.csv";
        private static string MODEL_FILEPATH = @"../../../../MessagingAppML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Text.FeaturizeText("content_tf", "content")
